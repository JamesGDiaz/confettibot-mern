        ...
        <div className={styles.app}>
          ...
          <div className={styles.body}>
            <Switch>
              ...
              <PrivateRoute path="/instrucciones" component={Instructions} authenticated={this.props.authenticated} exact />
              ...
              <PrivateRoute path='/app' component={ConfettibotApp} authenticated={this.props.authenticated} exact />
