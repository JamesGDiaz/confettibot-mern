                ...
                <Jumbotron className={styles.outputJumbotron}>
                    {this.state.searching ?
                        <div>
                            ...
                            {!this.state.answer_visibility ? <Spinner animation="grow" variant="primary" role="status" /> :
                        ...
                        <div>
                            ...
                            <p className={styles.messageQuestion}>Esperando siguiente pregunta...</p>
                        </div>
                    }

                    <Websocket
                        url={window.location.origin.replace(/^http/, "ws") + "/api/relay"}
